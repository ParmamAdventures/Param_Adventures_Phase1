  ...
  },
  {
    ...
    content: {
      ...
      content: [
        ...
        { type: "paragraph", content: [{ type: "text", text: "A brief summary of the entire trip... We started early morning and the weather was perfect for a long hike." }] },
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "Day 1: The Beginning" }] },
        { type: "paragraph", content: [{ type: "text", text: "We started our journey at the base camp." }] },
        ...
        { type: "paragraph", content: [{ type: "text", text: "This was truly a life changing experience." }] },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    content: {
      ...
      content: [
        ...
        { type: "paragraph", content: [{ type: "text", text: "The spicy noodles were incredible!" }] },
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "Street Food Finds" }] },
        { type: "paragraph", content: [{ type: "text", text: "Found a hidden gem selling momos." }] },
      ],
    },
  },
  {
    ...
    content: {
      ...
      content: [
        ...
        { type: "paragraph", content: [{ type: "text", text: "The locals welcomed us with open arms." }] },
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "Local Legends" }] },
        { type: "paragraph", content: [{ type: "text", text: "The village elder told us about the guardian spirit of the mountain." }] },
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "Festivals & Customs" }] },
        { type: "paragraph", content: [{ type: "text", text: "We were lucky to witness the harvest festival." }] },
      ],
    },
  },
];
