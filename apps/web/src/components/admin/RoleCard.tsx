  ...
  return (
    <Card className="group flex flex-col overflow-hidden border-[var(--border)] bg-[var(--card)] transition-all hover:border-[var(--accent)]/30 hover:shadow-[var(--accent)]/5 hover:shadow-2xl">
      <div className="flex items-center justify-between border-b border-[var(--border)] p-6">
        ...
        <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[var(--border)]/30 text-[var(--muted)] transition-transform group-hover:scale-110">
          <svg
      ...
      <div className="flex-1 space-y-8 bg-gradient-to-br from-transparent to-[var(--border)]/5 p-6">
        <PermissionGroup
          title="Trips"
      ...
      <div className="flex justify-end border-t border-[var(--border)] bg-[var(--border)]/10 p-4">
        <button
