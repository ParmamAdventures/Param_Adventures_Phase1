  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-[var(--bg)]">
        <div className="mx-auto max-w-5xl space-y-8 px-6 pt-24 pb-10">
          <div className="space-y-4">
            <h1 className="text-4xl font-black tracking-tighter uppercase italic">
              Member <span className="text-[var(--accent)]">Dashboard</span>
            </h1>

            <nav className="flex w-fit gap-2 rounded-2xl bg-[var(--border)]/20 p-1.5 backdrop-blur-md">
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-2 rounded-[14px] px-6 py-2.5 text-sm font-bold transition-all ${
                      isActive
                        ...
                        : "text-muted-foreground hover:text-foreground hover:bg-[var(--border)]/40"
                    } `}
                  >
                    {tab.icon}
                    {tab.name}
