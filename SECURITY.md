...
- **JWT (JSON Web Tokens)**: Used for stateless authentication. Access tokens are short-lived, and refresh tokens are stored in `HttpOnly`, `Secure`, `SameSite=Strict/Lax` cookies to prevent XSS and CSRF.
